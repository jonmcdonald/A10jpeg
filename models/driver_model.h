...
class driver_pv_base_parameters {
 public :
  driver_pv_base_parameters(sc_object* object);
                           ...
                           public driver_pv_base_parameters
{
 ...
 public:
  ...
  enum port_enum {master_idx,irq_idx };
 ...
 protected: 
  ...
  virtual void cb_signal_irq(bool value) {
    irq_callback();
  } 
...
public:
  ...
  driver_pvt_param_defaults(const char* hier_name, sc_core::sc_time clock_init, sc_core::sc_time signal_clock_init, sc_core::sc_time axi_clock_init, double nominal_voltage_init, bool mb_debug_init, bool verbose_parameters_init, bool dmi_enabled_init, const char* warning_level_init, unsigned int master_outstanding_init, unsigned int master_read_data_queue_size_init, unsigned int master_write_data_queue_size_init, unsigned int irq_pipeline_length_init) {
    ...
    irq_pipeline_length = ::mb::sysc::sdInitParameter<unsigned int>("irq_pipeline_length", irq_pipeline_length_init, hier_name);

    ::mb::sysc::sdPropagateParameters();
    }

  driver_pvt_param_defaults(const char* hier_name, std::vector<std::pair<char*, unsigned int> > &change_parameters){
...
class driver_pvt : public esl::sc_sim::PVTBaseModel, 
 ...
 public: 
  ...
  driver_pvt(sc_core::sc_module_name module_name, std::vector<std::pair<char*, unsigned int> > &change_parameters);
  ~driver_pvt(); 
 ...
 private:
  ...
  void b_transport_inside_irq(tlm::tlm_generic_payload& p, sc_core::sc_time& t); 
 ...
 public:
  ...
  master_type master;
  esl::sc_sim::pvt_target_socket<1, tlm::tlm_base_protocol_types, 1, sc_core::SC_ZERO_OR_MORE_BOUND> irq;
 ...
 private:
  ...
  struct master_nb_connector : public tlm::tlm_fw_nonblocking_transport_if<>, public ::mb::tlm20::socket_tracer_holder {
    driver_pvt& m_owner;
    master_nb_connector(driver_pvt& owner) : m_owner(owner) {
    }
  ...
  struct irq_nb_connector : public tlm::tlm_bw_nonblocking_transport_if<>, public ::mb::tlm20::socket_tracer_holder {
    driver_pvt& m_owner;
    irq_nb_connector(driver_pvt& owner) : m_owner(owner) {
    }
    virtual tlm::tlm_sync_enum nb_transport_bw(tlm::tlm_generic_payload& trans, 
                                               tlm::tlm_phase& phase, 
                                               sc_core::sc_time& t) {
      return m_owner.irq.nb_transport_bw((tlm::tlm_base_protocol_types::tlm_payload_type&)trans, phase, t);
    }
    virtual ::mb::tlm20::socket_tracer *get_socket_tracer() {
      return &m_owner.irq;
    }
