...
JPEG_ENCODER_pv_base::JPEG_ENCODER_pv_base(sc_module_name& module_name) : 
  ...
  input_w_h_size("input_w_h_size", &slave_memory, ((0x4) / 4), ( (0) + (((0x4) % 4) << 3)), ( (31) + (((0x4) % 4) << 3)),  (32), mb::tlm20::WRITE_ACCESS),
  ...
  status("status", &slave_memory, ((0x10) / 4), ( (0) + (((0x10) % 4) << 3)), ( (31) + (((0x10) % 4) << 3)),  (32), mb::tlm20::READ_ACCESS),
  ...
  input_w_h_size.setResetValue(0);
...
JPEG_ENCODER_machine_arch::JPEG_ENCODER_machine_arch()
    ...
    input_w_h_size.setValuePtr(values);
  ...
  )
{
  ...
  if ( _address == input_w_h_size.getAddress()) { 
      input_w_h_size = _data &(0xffffffff);
  }
...
Register* JPEG_ENCODER_machine_arch::getRegisterByName(const char* name) {
  ...
  if (!strcmp(name, "input_w_h_size")) {
    return &input_w_h_size;
  }
...
JPEG_ENCODER_t_base::JPEG_ENCODER_t_base(sc_module_name& module_name, long simulation) :
  ...
  input_w_h_size("input_w_h_size", this),
...
unsigned JPEG_ENCODER_t_base::getPortCountForRegister(unsigned regIndex) {
  if (!strcmp(get_register_name(regIndex), "inputaddr"))
    return 1;
  if (!strcmp(get_register_name(regIndex), "input_w_h_size"))
    return 1;
