...
//------------------------------------------------------------------------//
#define      Core_MGLS_no_license_at_server    (Core_MGLS_no_license_at_server \
                                                 | CORE_MODC_PFX_LICENSING)
//  Description:  The license server does not have any license keys
//  that can satisfy the checkout request.

//------------------------------------------------------------------------//
#define      Core_MGLS_invalid_hostid    (Core_MGLS_invalid_hostid \
                                                 | CORE_MODC_PFX_LICENSING)
//  Description:  The license key is nodelocked to a machine with a 
//  different hostid than the one requesting the license.

//------------------------------------------------------------------------//
#define      Core_MGLS_maxusers  (Core_MGLS_maxusers \
                                                 | CORE_MODC_PFX_LICENSING)
//  Description:  A checkout request failed because all possible license
//  keys are already checked out.

//------------------------------------------------------------------------//
#define      Core_MGLS_some_ok  (Core_MGLS_some_ok \
                                                 | CORE_MODC_PFX_LICENSING)
//  Description:  A request for a quantity of licenses was granted less 
//  than the desired quantity.

//------------------------------------------------------------------------//
#define      Core_MGLS_free_bad_transids  (Core_MGLS_free_bad_transids \
                                                 | CORE_MODC_PFX_LICENSING)
//  Description:  The function cannot be called until every transid
//  with a status other than MGLS_OK or MGLS_EXP_WARNING has been 
//  freed.

//------------------------------------------------------------------------//
#define      Core_MGLS_license_excluded  (Core_MGLS_license_excluded \
                                                 | CORE_MODC_PFX_LICENSING)
//  Description:  The checkout request failed because of the settings
//  for the MGLS include/exclude lists.
...
//------------------------------------------------------------------------//
#define      Core_MGLS_all_checked_in    (MGLS_all_checked_in \
                                                 | CORE_MODC_PFX_LICENSING)
//  Description:  The request to checkin a quantity of licenses checked
//  in all licenses for the transaction ID.

//------------------------------------------------------------------------//
#define      Core_MGLS_lost_licenses_at_freeq    (MGLS_lost_licenses_at_freeq \
                                                 | CORE_MODC_PFX_LICENSING)
//  Description:  Clients should not see this error.

//------------------------------------------------------------------------//
#define      Core_MGLS_quantity_exceeds_checkedout    (MGLS_quantity_exceeds_checkedout \
                                                 | CORE_MODC_PFX_LICENSING)
//  Description:  The application has requested the checkin of more 
//  licenses than are checked out by the transaction.

//------------------------------------------------------------------------//
#define      Core_MGLS_values_out_of_range    (MGLS_values_out_of_range \
                                                 | CORE_MODC_PFX_LICENSING)
//  Description:  The application has supplied a value to MGLS that 
//  is not within the proper range.

//------------------------------------------------------------------------//
#define      Core_MGLS_value_out_of_range    (MGLS_value_out_of_range \
                                                 | CORE_MODC_PFX_LICENSING)
//  Description:  The application has supplied a value, typically to 
//  an attribute setting, that is not within the proper range.

//------------------------------------------------------------------------//
#define      Core_MGLS_invalid_version_num    (MGLS_invalid_version_num \
                                                 | CORE_MODC_PFX_LICENSING)
//  Description:  The Exact Access version string was not in the 
//  correct format.
