...
//* Generated on: Jan. 27, 2016 06:40:29 PM, (user: mbradley)
//*>
...
class JPEG_ENCODER_pv_base;
class JPEG_ENCODER_pv_base_mb_compatibility : public mb::mb_module {
  friend class JPEG_ENCODER_pv_base;
 public:
  typedef unsigned int mb_address_type;
 protected:
  JPEG_ENCODER_pv_base_mb_compatibility(sc_core::sc_module_name& module_name)
...
class JPEG_ENCODER_pv_base_parameters {
 public :
  JPEG_ENCODER_pv_base_parameters(sc_object* object);
...
class JPEG_ENCODER_pv_base : public JPEG_ENCODER_pv_base_mb_compatibility,
                           public JPEG_ENCODER_pv_base_parameters
{
 private:
  typedef JPEG_ENCODER_pv_base_mb_compatibility mb_compatibility_class;
  typedef JPEG_ENCODER_pv_base_mb_compatibility BASE_TYPE;
 public:
  typedef esl::tlm_types::Address mb_address_type;
 public:
  typedef JPEG_ENCODER_pv_base self;
  SC_HAS_PROCESS(JPEG_ENCODER_pv_base);
  JPEG_ENCODER_pv_base(sc_core::sc_module_name& module_name);
  virtual void reset_model();
  enum port_enum {slave_idx,master_idx,irq_idx };
 ...
 protected:
  ...
  virtual unsigned int cb_read_status() = 0;
  virtual unsigned int cb_read_start() = 0;
 ...
 protected:
  ...
  virtual void cb_write_start(unsigned int newValue) = 0;
 ...
 protected:
  ...
  mb::mb_register<unsigned int> input_w_h_size;
  mb::mb_register<unsigned int> outputaddr;
  mb::mb_register<unsigned int> outputlength;
  mb::mb_register<unsigned int> status;
  mb::mb_register<unsigned int> start;
  mb::mb_variable<int> state_var;
  mb::mb_variable<int> jpeg_delay;
};
...
class JPEG_ENCODER_RemoteRegisters {
...
public:
  ...
  JPEG_ENCODER_RemoteRegisters(SOCKET& s, uint64_t baseAddress) :
    m_inputaddr(s[0], baseAddress, ((0x0) / 4), ( (0) + (((0x0) % 4) << 3)), ( (31) + (((0x0) % 4) << 3))),
    m_input_w_h_size(s[0], baseAddress, ((0x4) / 4), ( (0) + (((0x4) % 4) << 3)), ( (31) + (((0x4) % 4) << 3))),
    m_outputaddr(s[0], baseAddress, ((0x8) / 4), ( (0) + (((0x8) % 4) << 3)), ( (31) + (((0x8) % 4) << 3))),
    m_outputlength(s[0], baseAddress, ((0xC) / 4), ( (0) + (((0xC) % 4) << 3)), ( (31) + (((0xC) % 4) << 3))),
    m_status(s[0], baseAddress, ((0x10) / 4), ( (0) + (((0x10) % 4) << 3)), ( (31) + (((0x10) % 4) << 3))),
    m_start(s[0], baseAddress, ((0x14) / 4), ( (0) + (((0x14) % 4) << 3)), ( (31) + (((0x14) % 4) << 3))),
    m_dummy(0) {}
    
public:
  mb::mb_remote_register<unsigned int, TRANS> m_inputaddr;
  mb::mb_remote_register<unsigned int, TRANS> m_input_w_h_size;
  mb::mb_remote_register<unsigned int, TRANS> m_outputaddr;
  mb::mb_remote_register<unsigned int, TRANS> m_outputlength;
  mb::mb_remote_register<unsigned int, TRANS> m_status;
  mb::mb_remote_register<unsigned int, TRANS> m_start;
private:
  int m_dummy;
};
...
template <typename TRANS = tlm::tlm_generic_payload>
class JPEG_ENCODER_pv_RemoteRegisters : public JPEG_ENCODER_RemoteRegisters<TRANS> {
public:
  template <class SOCKET>
  JPEG_ENCODER_pv_RemoteRegisters(SOCKET& s, uint64_t baseAddress)
    : JPEG_ENCODER_RemoteRegisters<TRANS>(s, baseAddress) {
  }
};
...
class JPEG_ENCODER_machine_arch : public MachineArch { 
    
    public:
        Register	inputaddr;
        Register	input_w_h_size;
        Register	outputaddr;
        Register	outputlength;
        Register	status;
        Register	start;
        MbObjVariable<1>		state_var; // not updated during learning, to be used only in policies callbacks
        MbObjVariable<1>		jpeg_delay; // not updated during learning, to be used only in policies callbacks
...
class JPEG_ENCODER_t_base : public papoulis::SystemCBaseModel {
public:
  static JPEG_ENCODER_t_base* create_t(const char* _name, long simulation);
public:
  JPEG_ENCODER_t_base(sc_core::sc_module_name& module_name, long simulation);
 
  enum port_enum {slave, master, irq};
...
public:
  virtual JPEG_ENCODER_machine_arch* getMachineArch() const {
...
protected:
  ...
  JPEG_ENCODER_machine_arch* m_machineArch;

protected:
  friend class JPEG_ENCODER_model;
...
public:
  enum variable_enum {state_var_idx, jpeg_delay_idx };
protected:
  mb::mb_t_variable<int> state_var;
  mb::mb_t_variable<int> jpeg_delay; 
  
public:
  enum register_enum {inputaddr_idx, input_w_h_size_idx, outputaddr_idx, outputlength_idx, status_idx, start_idx };
protected:
  mb::mb_t_register<unsigned int> inputaddr;
  mb::mb_t_register<unsigned int> input_w_h_size;
  mb::mb_t_register<unsigned int> outputaddr;
  mb::mb_t_register<unsigned int> outputlength;
  mb::mb_t_register<unsigned int> status;
  mb::mb_t_register<unsigned int> start; 
  ...
  static const unsigned user_sequential_policy_count = 3;
...
class JPEG_ENCODER_pv;



using namespace std;

class JPEG_ENCODER_pvt_param_defaults {
  
public:
  JPEG_ENCODER_pvt_param_defaults(const char* hier_name) {
  ...
  JPEG_ENCODER_pvt_param_defaults(const char* hier_name, sc_core::sc_time clock_init, sc_core::sc_time signal_clock_init, sc_core::sc_time axi_clock_init, double nominal_voltage_init, bool mb_debug_init, bool call_to_default_if_init, bool verbose_parameters_init, bool dmi_enabled_init, const char* warning_level_init, unsigned int slave_pipeline_length_init, unsigned int slave_outstanding_init, unsigned int slave_read_data_queue_size_init, unsigned int slave_write_data_queue_size_init, unsigned int master_outstanding_init, unsigned int master_read_data_queue_size_init, unsigned int master_write_data_queue_size_init, double voltage_init) {
    ...
    voltage = ::mb::sysc::sdInitParameter<double>("voltage", voltage_init, hier_name);

    ::mb::sysc::sdPropagateParameters();
    }

  JPEG_ENCODER_pvt_param_defaults(const char* hier_name, std::vector<std::pair<char*, unsigned int> > &change_parameters){
...
class JPEG_ENCODER_pvt : public esl::sc_sim::PVTBaseModel, 
                          public mb::utl::cb_owner,
                          private JPEG_ENCODER_pvt_param_defaults {

 public:
  typedef JPEG_ENCODER_pvt self_type;

 public: 
  // Constructor
  JPEG_ENCODER_pvt(sc_core::sc_module_name module_name); 
  JPEG_ENCODER_pvt(sc_core::sc_module_name module_name, sc_core::sc_time clock_init, sc_core::sc_time signal_clock_init, sc_core::sc_time axi_clock_init, double nominal_voltage_init, bool mb_debug_init, bool call_to_default_if_init, bool verbose_parameters_init, bool dmi_enabled_init, const char* warning_level_init, unsigned int slave_pipeline_length_init, unsigned int slave_outstanding_init, unsigned int slave_read_data_queue_size_init, unsigned int slave_write_data_queue_size_init, unsigned int master_outstanding_init, unsigned int master_read_data_queue_size_init, unsigned int master_write_data_queue_size_init, double voltage_init); 
  JPEG_ENCODER_pvt(sc_core::sc_module_name module_name, std::vector<std::pair<char*, unsigned int> > &change_parameters);
  ~JPEG_ENCODER_pvt(); 

 
 public:
    //access the T instance
  inline JPEG_ENCODER_t_base* getT() const {
    return m_JPEG_ENCODER_t;
  }
  
  //access the PV instance
  inline JPEG_ENCODER_pv* getPV() const {
    return m_JPEG_ENCODER_pv;
  }
 ...
 private:
  ...
  //T instance
  JPEG_ENCODER_t_base* m_JPEG_ENCODER_t;
  
  //PV instance
  JPEG_ENCODER_pv* m_JPEG_ENCODER_pv;
 ...
 private:
  ...
  struct master_nb_connector : public tlm::tlm_fw_nonblocking_transport_if<>, public ::mb::tlm20::socket_tracer_holder {
    JPEG_ENCODER_pvt& m_owner;
    master_nb_connector(JPEG_ENCODER_pvt& owner) : m_owner(owner) {
    }
  ...
  struct irq_nb_connector : public tlm::tlm_fw_nonblocking_transport_if<>, public ::mb::tlm20::socket_tracer_holder {
    JPEG_ENCODER_pvt& m_owner;
    irq_nb_connector(JPEG_ENCODER_pvt& owner) : m_owner(owner) {
    }
    virtual tlm::tlm_sync_enum nb_transport_fw(tlm::tlm_generic_payload& trans, 
                                               tlm::tlm_phase& phase, 
                                               sc_core::sc_time& t) {
  ...
  struct slave_nb_connector : public tlm::tlm_bw_nonblocking_transport_if<>, public ::mb::tlm20::socket_tracer_holder {
    JPEG_ENCODER_pvt& m_owner;
    slave_nb_connector(JPEG_ENCODER_pvt& owner) : m_owner(owner) {
    }
