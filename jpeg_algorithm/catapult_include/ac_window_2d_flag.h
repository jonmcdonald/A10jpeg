...
template<class T, int AC_WN_ROW, int AC_WN_COL, int AC_NCOL, int AC_WMODE>
    ...
    ac_buffer_2d<T,AC_NCOL,AC_WN_ROW,AC_WMODE> vWind;  //Vertical window
    //ac_window_1d_flag<T,AC_WN_COL,AC_WMODE> hWind[AC_WN_ROW]; //horzizontal windows

    T   data_[AC_WN_ROW][AC_WN_COL];             // This array stores the input samples
    T   woutH_[AC_WN_ROW][AC_WN_COL];             // This array is what really gets read
    bool sol_[AC_WN_COL];  // Start of line control
    bool eol_[AC_WN_COL];  // End of line control
    ...
    T   wout_[AC_WN_ROW];             // This array stores the vWind output
    ac_int<logAC_NCOL,false> addr;  // Address counter for line buffers
    bool sofOut_[AC_WN_COL];  // Start of frame output control
    bool eofOut_[AC_WN_COL];  // End of frame output control
    bool sof_[AC_WN_ROW];  // Start of frame control
    bool eof_[AC_WN_ROW];  // End of frame control
...
template<class T, int AC_WN_ROW, int AC_WN_COL, int AC_NCOL, int AC_WMODE>
    ac_window_2d_flag<T, AC_WN_ROW, AC_WN_COL,AC_NCOL,AC_WMODE>::ac_window_2d_flag():
...
template<class T, int AC_WN_ROW, int AC_WN_COL, int AC_NCOL, int AC_WMODE>
    ac_window_2d_flag<T, AC_WN_ROW, AC_WN_COL,AC_NCOL,AC_WMODE>::ac_window_2d_flag(T bval):
        addr(0), rampup_(false), s(false), e(false), m(0)
{
#ifdef __SYNTHESIS__
#pragma hls_unroll yes
...
template<class T, int AC_WN_ROW, int AC_WN_COL, int AC_NCOL, int AC_WMODE>
    ...
    if(AC_WMODE == AC_WIN){
        ...
        sof = sofOut_[AC_WN_COL/2-AC_EVEN_ROW];
