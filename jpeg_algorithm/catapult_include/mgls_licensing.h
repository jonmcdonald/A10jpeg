...
#define       MGLS_no_license_at_server         (0x0a | MGLS_RUN)
#define       MGLS_invalid_hostid               (0x0b | MGLS_RUN)
#define       MGLS_flexlm_server_too_old        (0x20 | MGLS_RUN)
#define       MGLS_maxusers                     (0x21 | MGLS_RUN)
#define       MGLS_some_ok                      (0x22 | MGLS_RUN)
#define       MGLS_free_bad_transids            (0x23 | MGLS_RUN)
#define       MGLS_license_excluded             (0x24 | MGLS_RUN)
...
#define       MGLS_lost_asynch                  (0x8e | MGLS_WARN)
#define       MGLS_license_info_error           (0x8f | MGLS_WARN)
...
#define       MGLS_lost_licenses_at_freeq       (0x93 | MGLS_WARN)
#define       MGLS_all_checked_in               (0x94 | MGLS_WARN)
#define       MGLS_not_atomic_id                (0x95 | MGLS_WARN)
